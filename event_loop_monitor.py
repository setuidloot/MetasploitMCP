...
Configuration via environment variables:
    ...
    EVENT_LOOP_WATCHDOG: Set to 'true' to enable watchdog thread (default: false)
...
WATCHDOG_ENABLED = get_env_bool('EVENT_LOOP_WATCHDOG', False)
...
async def check_event_loop_health() -> dict:
    ...
    Returns a dict with health information.
    """
    loop = asyncio.get_running_loop()
